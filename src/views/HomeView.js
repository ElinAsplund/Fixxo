...
const HomeView = () => {
  ...
  const [products, setProducts] = useState([
    {id: 1, productName: "Mordern Black Blouse", category: "Fashion", price: "$35.00"},
    {id: 2, productName: "Testtest", category: "Fashion", price: "$35.00"},
    {id: 3, productName: "Mordern Black Blouse", category: "Fashion", price: "$35.00"},
    {id: 4, productName: "Mordern Black Blouse", category: "Fashion", price: "$35.00"} 
